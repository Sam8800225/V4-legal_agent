...
# Fonction utilitaire pour exécuter les coroutines
...
def test_list_folders():
    ...
    folder1 = run_async(dataroom_service.create_folder(FolderCreate(name="Folder 1")))
    folder2 = run_async(dataroom_service.create_folder(FolderCreate(name="Folder 2")))
...
def test_get_folder():
    ...
    # Crée un dossier
    folder = run_async(dataroom_service.create_folder(FolderCreate(name="Get Folder Test")))
...
def test_update_folder():
    ...
    # Crée un dossier
    folder = run_async(dataroom_service.create_folder(FolderCreate(name="Old Folder Name")))
...
def test_delete_folder():
    ...
    # Crée un dossier
    folder = run_async(dataroom_service.create_folder(FolderCreate(name="Folder To Delete")))
...
def test_list_files():
    ...
    # Crée un dossier
    folder = run_async(dataroom_service.create_folder(FolderCreate(name="Files Folder")))
    ...
    for i in range(3):
        ...
        with open(test_file_path, "rb") as f:
            ...
            run_async(dataroom_service.upload_file(upload_file, file_data))
...
def test_update_file():
    ...
    with open(test_file_path, "rb") as f:
        ...
        file = run_async(dataroom_service.upload_file(upload_file, file_data))
